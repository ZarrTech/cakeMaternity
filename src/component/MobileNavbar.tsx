...
const MobileNavbar: FC = () => {
  ...
  return (
    <div className=" relative navbar  lg:hidden  flex w-full p-4 bg-black">
      <button
        className="btn"
        onClick={() => {
      ...
      >
        <section className=" flex flex-col gap-8 absolute bg-white top-0 left-0 w-[250px] h-screen z-50">
          <button
            className="btn bg-transparent p-1 rounded-full border-slate-200 absolute top-3 right-5 "
            onClick={() => {
      ...
      <div className="flex-1">
        <a className="btn btn-ghost text-xl">CM</a>
      </div>
