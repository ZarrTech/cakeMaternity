...
import ChildrenCake from './ChildrenCake'
import DessertCake from './DessertCake'
import DoubleLayered from './DoubleLayered'
...
import TraditionalCake from './TraditionalCake'
import ThreeLayered from './ThreeLayered'
